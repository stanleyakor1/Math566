...
class Mgrid_transient3():
    ...
    def vycle(self,nx,ny,u,f):
        ...
        e_coarse,res_coarse=self.vycle(nx//2,ny//2,e_coarse,res_coarse) 
    
        u+=self.prolongation(nx//2,ny//2,e_coarse)
